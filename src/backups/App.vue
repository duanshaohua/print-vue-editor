    ...
    <div class="editor">
      ...
      <div class="editor_content">
        <div class="editor_data">
          <div class="main">
            <el-row :gutter="20">
              <el-col :span="item.span||12" v-for="(item, index) in dataList" :key="index">
                <el-button
                ...
                >
                  ...
                  <div class="el-collapse-item__content">
                    ...
                    <el-radio-group v-model="config.text.align">
                      <el-radio-button v-for="item in config.fontAlign" :label="item" :key="item">
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'page'">
                ...
                <div class="el-collapse-item__content">
                  ...
                  >
                    ...
                    <el-form-item label="宽度" prop="width">
                      <el-input-number
                        :disabled="config.page.size!=''"
                        v-model="config.page.width"
                        controls-position="right"
                        :min="50"
                        :max="1000"
                      ></el-input-number>
                    ...
                    <el-form-item label="水平偏移" prop="horizontalOffset" class="extrusion_line">
                      <el-input-number
                        v-model="config.page.horizontalOffset"
                        controls-position="right"
                        :min="0"
                        :max="config.page.width/2"
                      ></el-input-number>
                    </el-form-item>
                    <el-form-item label="垂直偏移" prop="verticalOffset" class="extrusion_line">
                      <el-input-number
                        v-model="config.page.verticalOffset"
                        controls-position="right"
                        :min="0"
                        :max="config.page.height/2"
                      ></el-input-number>
                    </el-form-item>
...
import editor from './mixin/editor.js'
import cnPrinter from './mixin/cn_printer.js'
import preview from './preview'
import { layoutData, dataList } from './utils/data'
export default {
  name: 'editor',
  components: {
    drag,
